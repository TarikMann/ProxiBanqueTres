...
@ManagedBean(name = "conseillerbean") // annotation qui permet de donner un nom � un objet (non instancier), nom qui
...
//	}
	...
	public Object appelTraitement() { // la Signature (retour Object) est document�e dans doc JSF commandButton /
...
//		if (service.createUser(Conseiller)) { // tous les objects creer pour un classe donnee peuvent utilis� les methodee
//											// de
//			// cette classe
//			return "resultatOK";
//		}
